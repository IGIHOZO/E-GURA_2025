        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              <Link
                to="/virtual-tryon"
                className="inline-flex items-center px-4 py-2 border border-orange-600 text-orange-400 rounded-lg hover:bg-orange-600 hover:text-white transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>
                <Link to="/virtual-tryon" className="hover:text-white transition-colors">Virtual Try-On</Link>
              </li>
              <li>
