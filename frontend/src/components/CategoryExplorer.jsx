...
const CategoryExplorer = () => {
  ...
  const generateAISuggestions = () => {
    ...
    const trending = [
      { name: "Women's Fashion", icon: '👗', trend: '+45%', color: 'from-pink-500 to-purple-500' },
      { name: 'Traditional & Cultural', icon: '🎎', trend: '+38%', color: 'from-orange-500 to-red-500' },
      { name: 'Special Occasions', icon: '🎉', trend: '+32%', color: 'from-blue-500 to-indigo-500' },
      { name: 'Custom & Tailored', icon: '✂️', trend: '+28%', color: 'from-green-500 to-teal-500' }
    ];
