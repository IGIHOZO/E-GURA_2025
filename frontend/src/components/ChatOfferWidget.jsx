    ...
    if (isOpen && messages.length === 0) {
      setTimeout(() => {
        addBotMessage(
          ...
          `💬 You can:\n` +
          `• Make me an offer (e.g., "I can pay 15000")\n` +
      ...
      setTimeout(() => {
        ...
        if (lowerText.includes('make an offer') || lowerText.includes('negotiate') || lowerText.includes('bargain')) {
          addBotMessage(
            ...
            `The current price is **${product.price?.toLocaleString()} RWF**.\n\n` +
            `Just tell me how much you'd like to pay. For example:\n` +
            `• "I can pay 15000"\n` +
            `• "How about 20000?"\n` +
            `• Or just type the amount: "18000"`
          );
          ...
          addBotMessage(
            ...
            `But here's the exciting part - I can negotiate with you! 🎯\n\n` +
            `Just make me an offer and let's see if we can work something out!`
          );
          ...
          addBotMessage(
            ...
            `To make an offer, just tell me a price. For example:\n` +
            `• "I'll pay 15000"\n` +
            `• "How about 20000 RWF?"\n` +
            `• Or simply: "15000"\n\n` +
            `Let's find you the best deal! 💪`
