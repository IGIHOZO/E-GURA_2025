...
const SEOHead = ({ 
  title = "E-Gura Store | Premium Fashion in Kigali, Rwanda",
  description = "Discover the latest fashion trends in Kigali, Rwanda. E-Gura Store offers premium clothing, accessories, and style inspiration. Free shipping, best prices, and exceptional quality.",
  keywords = "fashion, clothing, Kigali, Rwanda, E-Gura Store, online shopping, African fashion, Rwandan fashion, premium clothing, accessories, style, trends",
  image = "/logo.png",
  url = "",
  type = "website",
  product = null,
  ...
  const localBusinessSchema = {
    ...
    "name": "E-Gura Store",
    "description": "Rwanda's #1 online shopping platform for electronics, fashion, home appliances. Free delivery in Kigali, secure mobile money payments.",
    "url": "https://egura.rw",
    "telephone": "+250-788-000-000",
    "email": "support@egura.rw",
    "address": {
