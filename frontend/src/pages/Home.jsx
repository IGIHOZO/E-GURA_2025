...
const Home = () => {
  ...
  const categoriesList = [
    ...
    { name: 'Tops', icon: '👕', count: 18 },
    { name: 'Bottoms', icon: '👖', count: 15 },
    { name: 'Suits', icon: '👔', count: 12 },
    { name: 'Accessories', icon: '👜', count: 32 }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                to="/virtual-tryon"
                className="inline-flex items-center px-8 py-4 border-2 border-purple-600 text-purple-600 font-semibold rounded-full hover:bg-purple-600 hover:text-white transition-all transform hover:scale-105"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                to="/virtual-tryon"
                className="inline-flex items-center px-8 py-4 border-2 border-white text-white font-semibold rounded-full hover:bg-white hover:text-purple-600 transition-all transform hover:scale-105"
              >
                <SparklesIcon className="mr-2 h-5 w-5" />
                Try AI Fashion
              </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><Link to="/virtual-tryon" className="hover:text-white transition-colors">Virtual Try-On</Link></li>
