...
// Wrap new models
const wrappedCartEvent = wrapModel(CartEvent);
const wrappedProductRelation = wrapModel(ProductRelation);
...
module.exports = {
  ...
  CartEvent: wrappedCartEvent,
  ProductRelation: wrappedProductRelation
};
